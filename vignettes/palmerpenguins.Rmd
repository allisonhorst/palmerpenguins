...
<img src="https://raw.githubusercontent.com/allisonhorst/palmerpenguins/master/man/figures/lter_penguins.png" width=30% style="display:block; margin-left: auto; margin-right: auto;">
...
<figure>
  <img src="https://raw.githubusercontent.com/allisonhorst/palmerpenguins/master/man/figures/palmerpenguins.png" alt="The Palmer Archipelago penguins. Artwork by @allison_horst." width=60% style="display:block; margin-left: auto; margin-right: auto;">
...
ggsave("vignettes/penguin-visdat.png", width = 8)
```

```{r eval=TRUE, echo=FALSE}
knitr::include_graphics("penguin-visdat.png")
```
