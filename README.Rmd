...
One is called `penguins`, and is a simplified version of the raw data. All column names are in snake case to make them easier to work with, see `?penguins` for more info: 
...
You can find more visualizations for exploring palmerpenguins in `vignette("examples")`.
